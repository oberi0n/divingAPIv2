...
CREATE TABLE IF NOT EXISTS `equipment`.`Evenement` (
  ...
  INDEX `fk_Equipment_has_Utilisateur_Utilisateur1_idx` (`Utilisateur_idUtilisateur` ASC) ,
  INDEX `fk_Equipment_has_Utilisateur_Equipment_idx` (`Equipment_idEquipment` ASC) ,
