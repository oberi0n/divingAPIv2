...
@Entity
public class EquipmentNonDispo implements Serializable{
	@Id
	...
	public EquipmentNonDispo(Integer idEquipment, String libelle, String marque, String taille, String numeroSerie) {
		super();
		this.idEquipment = idEquipment;
		this.libelle = libelle;
		this.marque = marque;
